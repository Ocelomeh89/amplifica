...
// The 12-field simulator input grid. The name= attributes match the FormData
// contract of updateProjection (projections/actions.ts); they are inert on the
// public calculator, where the grid is not wrapped in a form.
export default function SimInputsGrid({ values, set, initialInvestmentSize }: Props) {
